...
| deterministic choices | Forge-era wake reduction included forced choices, native payment, no-choice combat, and post-action waits. | Port only engine-certified/actually-forced equivalents: forced parameterless/structured choices, no-choice combat, Argentum-certified legacy damage assignment, and Argentum's native mana-payment policy. The newer CombatResolutionDecision remains strategic. Argentum already owns priority auto-pass/post-action progression. |
