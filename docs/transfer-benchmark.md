...
build leakage-safe source-group identities, and prepare model adapters.
...
#113 owns external model/dataset provenance and source-group semantics. #114 must not
...
- an exact `case_id -> source_group_id` mapping supplied by the #113 dataset/import
  layer.
...
judgments, recorded choices, outcomes, deck identity, source groups, and provenance do
