...
export COMMANDER_GYM_GATEWAY_BIND="${COMMANDER_GYM_GATEWAY_BIND:-127.0.0.1}"
export COMMANDER_GYM_GATEWAY_PORT="${COMMANDER_GYM_GATEWAY_PORT:-8082}"
export COMMANDER_GYM_GATEWAY_UPSTREAM="${COMMANDER_GYM_GATEWAY_UPSTREAM:-http://127.0.0.1:8081}"
